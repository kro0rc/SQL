...
VALUES
('.net development course', 'course contains lot of tasks which improve technical skills'), ('Java development course', 'course contains lot of tasks which improve developers skills'), ('Python development course', 'course contains lot of tasks which improve developers skills');

INSERT INTO GROUPS([course_id],[name]) 
VALUES
(1, 'SR-01'), (1, 'SR-02'), (2, 'JD-03'), (3, 'PT-66');
...
(4,'Charissa','Shepherd'),(4,'Xena','Wilkerson'),(4,'Madison','Diaz'),(4,'Tanner','Webb'),(4,'Mohammad','Pratt'),(4,'Belle','Hewitt'),(4,'Quentin','Gould'),(4,'TaShya','Duke');
